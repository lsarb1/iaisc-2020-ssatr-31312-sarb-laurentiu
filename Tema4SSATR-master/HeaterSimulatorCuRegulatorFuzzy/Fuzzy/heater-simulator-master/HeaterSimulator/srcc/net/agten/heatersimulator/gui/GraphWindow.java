...
import net.agten.heatersimulator.controller.dto.FuzzyLogicParameters;
...
public class GraphWindow {
	...
	private final String[] ALGORITHMS = {"PID32", "CAAPID32", "CAAPID16", "LogicaFuzzy"};
	...
	private final FuzzyLogicParameters fuzzyParams;	
	...
	public GraphWindow() {
		...
		fuzzyParams = new FuzzyLogicParameters();
	...
	private JPanel createAlgorithmPanel() {
		...
		algorithmParamsPanel.add(createFuzzyPanel(), "LogicaFuzzy");
	...
	private JPanel createFuzzyPanel() {
		JPanel algorithmPanel = new JPanel();
		algorithmPanel.setLayout(new BoxLayout(algorithmPanel, BoxLayout.Y_AXIS));
		algorithmPanel.add(createSliderPanel("agressiveness:", fuzzyParams.getAggressiveness(), 0, 9,
				new ValueChangedAction() {
			@Override
			public void valueChanged(double newValue) {
				fuzzyParams.setAggressiveness(newValue);
			}
		}));
	...
	private XYDataset generateDataset() {
		...
		}else if ("LogicaFuzzy".equals(algo)) {
	...
	private JPanel createSliderPanel(String labelText, double initialValue, int min, int max, final int divisor,
		...
		text.setMaximumSize(new Dimension(30,30));
