...
import net.agten.heatersimulator.domain.algorithm.LogicaFuzzy;
...
public class Simulator {
	...
	public XYDataset runSimulation(SimulationParameters params, FuzzyLogicParameters pidParams) {
		ControllerAlgorithm pid = new LogicaFuzzy(pidParams.getAggressiveness());
		return runSimulation(params, pid);
	}
